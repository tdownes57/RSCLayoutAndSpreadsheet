...
Public Class RSCFieldSpreadsheet_NotInUse
    ...
    Private Sub RSCFieldSpreadsheet_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Dim eachColumn As RSCFieldColumn_NotInUse
    ...
    ''Private Function GenerateRSCColumn() As RSCFieldColumn_NotInUse
    ''    ''
    ''    ''Added 3/8/2022 td
    ''    ''
    ''    Dim objNewColumn As RSCFieldColumn_NotInUse ''Added 3/8/2022 td
    ...
    ''    objNewColumn = RSCFieldColumn_NotInUse.GetFieldColumn(objGetParametersForGetControl,
    ...
    Private Sub RemoveRSCColumnsFromDesignTime()
        ...
        ''
        Dim listRSCColumns As New List(Of RSCFieldColumn_NotInUse)

        For Each each_control As Control In Me.Controls
            If (TypeOf each_control Is RSCFieldColumn_NotInUse) Then

                each_control.Dispose()
                each_control.Visible = False
                listRSCColumns.Add(each_control)

            End If
        Next each_control

        For Each each_control As RSCFieldColumn_NotInUse In listRSCColumns
