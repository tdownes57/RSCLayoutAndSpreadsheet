...
Partial Class RSCFieldSpreadsheet_NotInUse
    ...
    Private Sub InitializeComponent()
        Me.RscFieldColumn5 = New __RSCWindowsControlLibrary.RSCFieldColumn_NotInUse()
        Me.RscFieldColumn4 = New __RSCWindowsControlLibrary.RSCFieldColumn_NotInUse()
    ...
    Friend WithEvents RscFieldColumn1 As RSCFieldColumn_NotInUse
    Friend WithEvents RscFieldColumn2 As RSCFieldColumn_NotInUse
