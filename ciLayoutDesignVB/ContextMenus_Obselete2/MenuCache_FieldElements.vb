...
Public Class MenuCache_FieldElements
    ...
    Private Shared Sub Generate_BasicEdits() ''Dec.13 2021'' (par_fieldAny As ciBadgeFields.ClassFieldAny)
        ...
        ''
        ''Moved about 15 lines below. 12/28/021''Dim strList_MenuItems As String = ""

        ''Dim objInfo As Type ''System.Reflection.Assembly
        ''Encapsulated 12/28/2021 td''Dim each_methodInfo As Reflection.MethodInfo
        ...
        ''Encapsulated 12/28/2021 Thomas Downes
        Generate_ReflectionWork(Operations_Edit.GetType())
