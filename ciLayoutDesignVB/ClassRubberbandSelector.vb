...
Public Class ClassRubberbandSelector
    ...
    Public FieldControls_GroupEdit As List(Of CtlGraphicFieldV3)
    Public FieldControls_All As List(Of CtlGraphicFieldV3)
    ...
    Private Function InsideAFieldControl(par_x As Integer, par_y As Integer) As Boolean
        ...
        ''Added 9/20/2019 td  
        ''
        Dim each_ctl As CtlGraphicFieldV3
    ...
    Private Sub HighlightSelectedFields(par_rect As Rectangle)
        ...
        ''Added 9/20/2019 td 
        ''
        Dim each_fieldCtl As CtlGraphicFieldV3
