...
Public Class DLLUserControlRichbox
    ...
    End Function ''End of ""Public Function DLL_GetItemAtIndex_b0(par_index_b0 As Integer) As UserControlRichBox""
    ...
    ''
    ''
    ''Public Function DLL_GetItemNext_PriorSortOrder() As UserControlRichBox Implements IDoublyLinkedItem(Of UserControlRichBox).DLL_GetItemNext_PriorSortOrder
    ''    ''DIFFICULT AND CONFUSING -- Added 12/12/2024 
    ''    Return mod_next_priorSortOrder
    ''End Function
    ''
    ''Public Sub DLL_SetItemNext_PriorSortOrder(param As UserControlRichBox) Implements IDoublyLinkedItem(Of UserControlRichBox).DLL_SetItemNext_PriorSortOrder        ''Throw New NotImplementedException()
    ''    ''DIFFICULT AND CONFUSING -- Added 12/12/2024 
    ...
    End Function ''End of Public Function GetConvertToArray() As UserControlRichBox()
