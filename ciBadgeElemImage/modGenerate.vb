...
Public Module modGenerate
    ...
    Public Function TextImage_ByElemInfo(par_Text As String,
        ...
        ''
        ''
        ''3/9/2023  Dim local_image_of_element As Bitmap ''Added 9/4/2019 td  
        ''3/9/2023  Dim gr_local_image_of_element As Graphics ''= Graphics.FromImage(img)
        ''3/9/2023  Dim pen_backcolor As Pen
        ''3/9/2023  Dim pen_highlighting As Pen ''Added 8/2/2019 thomas downes  
        ''3/9/2023  Dim pen_border As Pen ''Added 9/3/2019 thomas downes  
        ''3/9/2023  Dim brush_forecolor As Brush
        ...
        ''3/9/2023  Dim intStarting_Width As Integer ''Added 8/19/2019 thomas 
        ''3/9/2023  Dim intStarting_Height As Integer ''Added 8/19/2019 thomas
        ...
        ''03/09/2023 Dim intNewElementWidth As Integer ''Added 8/15 
        ''03/09/2023 Dim intNewElementHeight As Integer ''Added 8/15
        ...
        ''
        ''Encapsulated 0309/2023 
        ''
        Return TextImage_ByElemInfo(par_Text, doubleScalingW, doubleScalingH,
                        par_elementInfo_TextFld, par_elementInfo_Base,
