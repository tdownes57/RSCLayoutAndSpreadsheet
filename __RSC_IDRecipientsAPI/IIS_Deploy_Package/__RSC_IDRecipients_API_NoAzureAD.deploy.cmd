...
set _DeploySetParametersFile=%RootPath%__RSC_IDRecipients_API_NoAzureAD.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%__RSC_IDRecipients_API_NoAzureAD.zip" (
echo "%RootPath%__RSC_IDRecipients_API_NoAzureAD.zip" does not exist. 
...
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%__RSC_IDRecipients_API_NoAzureAD.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension
) else (
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%__RSC_IDRecipients_API_NoAzureAD.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%_DeploySetParametersFile%"
)
...
:usage
echo =========================================================
if not exist "%RootPath%__RSC_IDRecipients_API_NoAzureAD.deploy-readme.txt" (
...
start notepad "%RootPath%__RSC_IDRecipients_API_NoAzureAD.deploy-readme.txt"
)
echo =========================================================
goto :eof
