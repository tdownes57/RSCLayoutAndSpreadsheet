...
Public Class RSCSpreadManagerCols
    ''Lets's re-think this... Occam & so forth. 11/2023 Implements IDoublyLinkedList ''Added 11/20/2023 td
    ''
    ''Added 4/18/2023 
    ''
    ...
    ''Public Sub InsertColumnLeftOfSpecified_Obselete(par_columnExisting As RSCFieldColumnV2,
    ''                                  par_intPixelsBetweenRows As Integer)
    ''    ''
