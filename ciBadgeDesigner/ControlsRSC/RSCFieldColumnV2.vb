...
Public Class RSCFieldColumnV2
    ...
    Public Shared Function GetRSCFieldColumn(par_parametersGetElementControl As ClassGetElementControlParams,
        ...
        ''Create the control. 
        Dim CtlFieldColumn1 = New RSCFieldColumnV2(par_field, par_formParent,
                                                  par_iLayoutFun,
    ...
    Public Function ListOfRSCDataCells_TopToBottom(Optional par_bSkipSorting As Boolean = False) As List(Of RSCDataCell) ''IOrderedEnumerable(Of RSCDataCell)
        ...
        ''Added 3/19/2022 td
        ''
        Dim objListOfRSCDataCelles As New List(Of RSCDataCell)
        ...
        For Each eachCtl As Control In Me.Controls
            If (TypeOf eachCtl Is RSCDataCell) Then
                ...
                objListOfRSCDataCelles.Add(CType(eachCtl, RSCDataCell))
                ''End If
        ...
        ''Added 4/2/2022 td
        If (par_bSkipSorting) Then Return objListOfRSCDataCelles

        Dim objListOfRSCDataCelles_Ordered As List(Of RSCDataCell)
        objListOfRSCDataCelles_Ordered = objListOfRSCDataCelles.OrderBy(Of Integer)(Function(a) a.Top).ToList()
