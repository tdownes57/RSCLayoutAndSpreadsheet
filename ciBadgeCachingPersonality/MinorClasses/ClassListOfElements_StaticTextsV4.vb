...
Public Class ClassListOfElements_StaticTextsV4
    ...
    ''Added 2/01/2022 thomas downes
    ''
    Public Property ListOfElements_Front As HashSet(Of ClassElementStaticTextV4)
    Public Property ListOfElements_Backside As HashSet(Of ClassElementStaticTextV4)
