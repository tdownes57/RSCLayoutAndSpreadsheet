...
Public Class ClassListOfElements_QRCodes
    ...
    Public Property ListOfElements_Front As HashSet(Of ClassElementQRCode)
    Public Property ListOfElements_Backside As HashSet(Of ClassElementQRCode)
