...
Public Class ClassListOfElements_StaticTextsV3
    ...
    Public Property ListOfElements_Front As HashSet(Of ClassElementStaticTextV3)
    Public Property ListOfElements_Backside As HashSet(Of ClassElementStaticTextV3)
