...
Public Class FormTextEditor
    ''
    ''Added 4/26/2022 & 4/14/2022 thomas downes
    ''
    Public EditedOutputValue As String
    ...
    Private Sub ButtonOK_Click(sender As Object, e As EventArgs) Handles ButtonOK.Click
        ...
        ''
        ''April 26, 2022''Me.HowManySpecified = CInt(textHowMany.Text.Trim())
        Me.EditedOutputValue = TextBox1.Text.Trim()
