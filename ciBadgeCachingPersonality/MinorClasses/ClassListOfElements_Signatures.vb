...
Public Class ClassListOfElements_Signatures
    ...
    Public Property ListOfElements_Front As HashSet(Of ClassElementSignature)
    Public Property ListOfElements_Backside As HashSet(Of ClassElementSignature)
