...
Public Class Operations__Generic
    ...
    ''
    ''12/13/2022 Public Property Parent_MenuCache As MenuCache_Generic_NotUsed ''Added 12/12/2021 td 
    ...
    ''Not in use. Dec29 2021''Private mod_fauxMenuEditSingleton As CtlGraphPopMenuEditSingle ''Added 10/3/2019 td 
    ...
    Public Sub Moveability_Add_GG7004(sender As Object, e As EventArgs)
        ...
        ''Added 12/28/2021 thomas downes  
        ''
        ''Jan4 2022 td''CtlCurrentElement.AddMoveability()
        ''#2 Jan4 2022 td''CtlCurrentElement.AddMoveability(Me.EventsForMoveability)
