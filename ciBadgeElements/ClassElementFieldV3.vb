...
#Disable Warning CA1707 ''Warning re. Don't use underscores in names.
    ...
    Public Function Width_Pixels_Step2TextHandler(Optional psingleScaling As Single = 1.0) As Integer
        ...
        Select Case (Me.OrientationInDegrees)
            Case 90, 270
                ...
                ''9/5/2022 Return CInt(CSng(mod_height_pixels) * psingleScaling)
                Return CInt(CSng(Height_Pixels) * psingleScaling)

            Case Else '' Case 0, 180, 360

                ''Dec.11 2021 ''Return mod_width_pixels 
                ''9/5/2022 Return CInt(CSng(mod_width_pixels) * psingleScaling)
                Return CInt(CSng(Width_Pixels) * psingleScaling)
    ...
    Public Function Height_Pixels_Step2TextHandler(Optional psingleScaling As Single = 1.0) As Integer
        ...
        Select Case blIsRotatedSoSwitchWH ''RotatedSwitch_WidthHeight() ''(Me.OrientationInDegrees)
            ...
            Case True '' 90, 270
                ...
                ''Dec.11 2021 ''Return mod_width_pixels
                ''Sept. 4 2022 ''Return CInt(CSng(mod_width_pixels) * psingleScaling)
                Return CInt(CSng(Width_Pixels) * psingleScaling)

            Case Else '' Case 0, 180, 360

                ''Dec.11 2021 ''Return mod_height_pixels
                ''Sept. 4 2022 ''Return CInt(CSng(mod_height_pixels) * psingleScaling)
                Return CInt(CSng(Height_Pixels) * psingleScaling)
    ...
    ''9/05/2022 td''Public Property Border_WidthInPixels As Integer = 1 Implements IElement_Base.Border_WidthInPixels

    ''9/05/2022 td''<XmlIgnore>
    ''9/05/2022 td''Public Property Border_Color As System.Drawing.Color = Color.Black Implements IElement_Base.Border_Color
    ''9/05/2022 td''Public Property Border_Displayed As Boolean = True Implements IElement_Base.Border_Displayed ''Added 9/9/2019 td 

    ''9/05/2022 td''<XmlElement("Border_Color")>
    ''9/05/2022 td''Public Property Border_Color_HTML As String
    ''    ''Added 10/13/2019 td
    ''    Get
    ''        ''  https://stackoverflow.com/questions/376234/best-solution-for-xmlserializer-and-system-drawing-color
    ...
    ''<XmlIgnore>
    ''9/06/2022  Public Property Back_Color As System.Drawing.Color = Color.White Implements IElement_Base.Back_Color
    ''9/06/2022  Public Property Back_Transparent As Boolean = False Implements IElement_Base.Back_Transparent ''Added 9/4/2019 thomas d. 
    ...
    ''9/06/2022  <XmlElement("Back_Color")>
    ''9/06/2022  Public Property Back_Color_HTML As String
    ''    ''Added 10/13/2019 td
    ''    Get
    ''        ''  https://stackoverflow.com/questions/376234/best-solution-for-xmlserializer-and-system-drawing-color
    ...
    ''9/06/2022  Public Property SelectedHighlighting As Boolean Implements IElement_Base.SelectedHighlighting ''Added 8/2/2019 td  

    ''9/06/2022  Public Property Visible As Boolean = True Implements IElement_Base.Visible ''Added 9/19/2019 td  
