...
Public Class ClassLabelToImage
    ...
    Public Function TextImage_Field(pintDesiredLayoutWidth As Integer,
                              ...
                              Optional par_pictureBox As PictureBox = Nothing) As Image
        ''9/18/2019 td''      Optional par_graphicalCtl As CtlGraphicFldLabel = Nothing) As Image
        ''
        ...
        If (boolClashOfColors) Then
            If (Not s_boolRunOnce) Then
                ...
                ''Added 8/29/2019 td
                ''9/18/2019 td''DialogDisplayColor.ShowColor("par_design.BackColor", par_elementInfo_Base.Back_Color)
        ...
        If (boolLetsRotate90) Then
            ...
            For intRotateIndex = 1 To CInt(par_elementInfo_Base.OrientationInDegrees / 90)
                ...
                If (par_pictureBox IsNot Nothing) Then
                    ...
                    ''9/18/2019 td''par_graphicalCtl.Width = intStarting_Height ''Switching!!  Height & Width are switched. ---8/8/2019 td
                    ''9/18/2019 td''par_graphicalCtl.Height = intStarting_Width ''Switching!!  Height & Width are switched. ---8/8/2019 td 
